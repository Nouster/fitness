...
<ul class="nav bg-dark text-light py-3">
 ...
 <div class="mb-3 row justify-content-center align-items-center">
		    <div class= "col-md-4 ">
			      <label class="form-label">Edit Tapis</label>
			      <input type="text" class="form-control" placeholder="Nom du tapis" name = "NOM_TAPIS">
			      <button type="Submit" class="btn btn-success my-5">EDIT</button>
			      <input type="hidden" name="id" value="${tapis.id}">
			      <button type="Submit" class="btn btn-danger my-5">DELETE</button>
		   	</div>
		</div>
</body>
</html>